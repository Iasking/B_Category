...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Iasking/B_Category"
  ...
  s.author             = { "Iasking" => "1012948435@qq.com" }
  ...
  s.source       = { :git => "https://github.com/Iasking/B_Category.git", :tag => s.version.to_s }
